...
GO
INSERT [dbo].[Customer] ([CustomerID], [CustomerFullName], [Telephone], [EmailAddress], [CustomerBirthday], [CustomerStatus], [Password]) VALUES (12, N'System Administrator', N'0000000000', N'admin@FUMiniHotelSystem.com', CAST(N'1990-01-01' AS Date), 1, N'@@abc123@@')
GO
